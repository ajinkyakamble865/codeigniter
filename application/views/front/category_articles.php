...
<div class="container">
    <h3 class="pb-4 pt-4">Blog / <?php echo $category['name']; ?></h3>
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-8">
            <p class="bg-light pt-2 pb-2 pl-4">
                <a href="<?php echo base_url('blog/category/'.$article['category']);?>" class="text-muted text-uppercase"><?php echo $article['category_name'];?></a>
            </p>
            <h3><a href="<?php echo base_url('blog/detail/'.$article['id']);?>" class="text-muted"><?php echo $article['title'];?></a></h3>
            <p class="text-muted"><?php echo word_limiter(strip_tags($article['description']),50);?>
